...
//defibniendo los valores comprendido para dichas variables//
...
echo  "<h2>Estimado $nombre  $apellido, portador del DNI: $dni , le informamos que el dia de hoy: $diasdelasemana[$dia], de acuerdo al nivel de evaluacion obtenido: $evaluacionestodas[$calificacion], usted ha recivido un aumento de $$aumento , siendo su sueldo total de: $$nuevo_sueldo</h2>";
